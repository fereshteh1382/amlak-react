...
exports.getPost_json = async (req, res, next) => {
    const postId = req.params.id;
    try {
        const course = await Blog.findById(postId);
        if (!course) {
