...
router.get("/allposts", adminController.getDashboard);
router.get("/allposts_json", adminController.getAllposts_json);
router.get("/post_json", adminController.getPost_json);
